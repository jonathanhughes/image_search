...
class _MyHomePageState extends State<MyHomePage> {
  ImageResultService _imageResultService = ImageResultService();
  List<ImageResult> _imageResults = [];

  Future _searchImages(String text) async {
    List<ImageResult>? imageResults = await _imageResultService.getAll(text);
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            SearchBar(onChanged: _searchImages,),
            ImageResultScrollContainer(results: _imageResults),
          ],
        ),
      ),
    );
